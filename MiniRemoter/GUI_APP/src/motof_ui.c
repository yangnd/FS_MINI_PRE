...
//	joystick2=getJoystick2DirD();
	...
	if(page%3==0)
	{
		...
		memset(str,0,22);
		sprintf(str,"Thrt:%d",motoF_Data.Throttle);
		oled_showString(0,32,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"Mode: %c",motoF_Data.Mode);
		oled_showString(0,48,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"RPM:%d",motoF_Data.RPM);
		oled_showString(64,16,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"MotoT:%d",motoF_Data.MotoTemp);
		oled_showString(64,32,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"DrvT:%d",motoF_Data.DriverTemp);
		oled_showString(64,48,(u8*)str,6,12);
	}
	else if(page%3==1)
	{
		memset(str,0,22);
		sprintf(str,"Volt:%.1f",motoF_Data.Voltage);
		oled_showString(0,16,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"Curr:%.1f",motoF_Data.Current);
		oled_showString(0,32,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"Dist:%.1f",motoF_Data.Distance);
		oled_showString(0,48,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"ErrC:%d",motoF_Data.ErrorCode);
		oled_showString(64,16,(u8*)str,6,12);
	}
	else if(page%3==2)
	{
		memset(str,0,22);
		sprintf(str,"TrqC:%.1f",motoF_Data.TorqueCtrl);
		oled_showString(0,16,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"RPMC:%d",motoF_Data.RPMCtrl);
		oled_showString(0,32,(u8*)str,6,12);
		
		memset(str,0,22);
		sprintf(str,"Trq:%.1f",motoF_Data.Torque);
		oled_showString(0,48,(u8*)str,6,12);
	}
